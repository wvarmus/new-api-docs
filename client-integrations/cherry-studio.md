...
* **API 地址 (API Base URL)**：填入本站的核心地址：`https://infistar.ai/v1`
...
* **原因**：通常是 API 地址填写不完整。
* **解决方法**：请确保地址为 `https://infistar.ai/v1`，不要漏掉结尾的 `/v1`。
...
* **长文档翻译**：可选择适合长上下文和翻译任务的模型。
* **代码助手**：可选择适合代码分析或推理任务的模型，在 Cherry Studio 侧边栏进行代码逻辑分析。
