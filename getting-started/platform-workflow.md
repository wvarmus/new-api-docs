...
当前支持快速注册，用户可使用账号密码完成登录。
* 您只需在官网首页点击“注册”。
* 填写您自定义的用户名和密码。
* 点击提交即可完成注册。请妥善保管账号信息，避免泄露造成损失。
...
* **平台在线充值**：前往“个人中心 -> 钱包管理”，选择金额后，使用微信或支付宝直接扫码支付。支付完成后，账户余额将根据支付结果自动更新，到账状态以钱包记录为准。
* **电商卡密兑换**：如果您在我们的淘宝店铺购买了充值卡密，请点击顶部的“兑换码/卡密兑换”，粘贴您的卡密即可完成充值。

## 第四步：在目标软件中配置中转

这是最关键的一步。无限星河AI 兼容 OpenAI 常用接口格式，可接入多数支持自定义接口的客户端（如沉浸式翻译、Chatbox、SillyTavern 酒馆等）；具体能力以客户端配置与平台支持接口为准。
